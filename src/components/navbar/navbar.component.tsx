  ...
  return (
    <header className="sticky top-0 z-50 bg-[#0f0f10] text-white border-b border-gray-700 border-opacity-40 backdrop-blur">
      <div className="w-full bg-gradient-to-r from-[#25d170] to-[#139f8b] text-center py-2 text-sm font-semibold">
        Yaz İndirimi: Tüm ürünlerde %20 indirim! — Hemen keşfet 🚀
      </div>
      <div className="max-w-screen-2xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <a href="/cart" className="relative p-2  transition-all duration-300 overflow-hidden group">
          ...
          <a href="/account" className="relative p-2 ransition-all duration-300 overflow-hidden group">
