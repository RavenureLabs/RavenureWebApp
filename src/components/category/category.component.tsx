...
export default function CategoryComponent(category: CategoryComponentType) {
    ...
    return(
          <a onClick={category.clickHandler} className="hover:cursor-pointer relative px-6 py-2 text-white text-sm font-medium rounded-full overflow-hidden group transition-all duration-300">
